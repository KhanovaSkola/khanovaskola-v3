...
class Form extends Nette\Application\UI\Form
{
	...
	{
		$w = $this->getRenderer()->{'wrappers'};
		$w['controls']['container'] = NULL;
		$w['pair']['container'] = 'div class=form-group';
		$w['pair']['.error'] = 'has-error';
		$w['control']['container'] = 'div class=col-sm-9';
		$w['label']['container'] = 'div class="col-sm-3 control-label"';
		$w['control']['description'] = 'span class=help-block';
		$w['control']['errorcontainer'] = 'span class=help-block';

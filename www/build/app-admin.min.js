...
$(function(){function t(){var t=[];return $("#content-editor").find("li").each(function(){t.push($(this).data("content-id"))}),t}var n=$(".block-editor");if(n.length){$("#content-editor, #content-editor-remove, #content-editor-add").sortable({connectWith:".drag",start:function(){$(".drag").addClass("highlight")},stop:function(){$(".drag").removeClass("highlight")}}).disableSelection();var o=$("#content-editor-add");$("#filter").on("keyup change",function(){App.autocomplete($(this).val(),function(t){o.find("li").remove(),$.each(t,function(t,n){o.append($("<li/>").data("content-id",n.id).text(n.value))})})}),$("#frm-blockForm-form-save").on("click",function(){var n=JSON.stringify(t());$("#frm-blockForm-form-contents").val(n)})}});
$(function(){function e(e){var t=e.className.match(/(^|\s+)(arrow-.*?)(\s+|$)/);return t?t[2]:null}function t(){var t=[];return $(".scheme-wrapper.editor").find(".col").each(function(){var i=[];$(this).find(".cell").each(function(){$cell=$(this);var t=$cell.data("id");if(i.length%2===0)i.push(t);else{var r=e($cell[0]),a=r?[r]:[];$cell.children("span").each(function(){(arrow=e($(this)[0]))&&a.push(arrow)}),i.push(a)}}),t.push(i)}),t}var i=$(".schema-editor");if(i.length){var r=$(".scheme-wrapper.editor .cell-even");$(".arrow-picker .cell").draggable({revert:!0,start:function(){r.addClass("highlight")},stop:function(){r.removeClass("highlight")}}),r.droppable({tolerance:"pointer",addClasses:!1,drop:function(t,i){var r=e(i.draggable[0]);$(this).append($("<span/>").addClass(r))}});var a,o=$(".scheme-wrapper.editor .cell-odd");o.on("mouseenter",function(){a=$(this)}),$(".block-picker li").draggable({tolerance:"pointer",revert:!0,revertDuration:0,cursorAt:{left:-20,top:-20},start:function(){o.addClass("highlight")},stop:function(){o.removeClass("highlight"),console.log($(this).data("id"));var e=$(this).data("id"),t=$(this).text();a.data("id",e).html('<i class="icon icon-math text-blue"></i>'+$("<span/>").text(t)[0].outerHTML),a[0].className="cell cell-odd"}}),r.on("mousedown",function(e){return 3===e.which?($(this).html(""),!1):void 0}),o.on("mousedown",function(e){return 3===e.which?($(this).data("id",null).html(""),!1):void 0}),window.debug=t,$("#frm-schemaForm-form-save").click(function(){var e=JSON.stringify(t());$("#frm-schemaForm-form-layout").val(e)}),$("#filter").on("keyup change",function(){var e=$(this).val();e?($(".block-picker li").hide(),$(".block-picker li").each(function(){0===$(this).text().indexOf(e)&&$(this).show()})):$(".block-picker li").show()})}});
$(function(){function t(){var t={},i=0;return e.find("li").each(function(){t[$(this).data("schema-id")]={position:i++}}),t}var i=$(".subject-editor");if(i.length){$(".drag").sortable().disableSelection();var e=$(".schema-list");$("#frm-subjectForm-form").on("submit",function(){$("#frm-subjectForm-form-positions").val(JSON.stringify(t()))}),$("#frm-subjectForm-form-editors").chosen({no_results_text:"Email nenalezen"})}});
$(function(){function a(){var a={},n=0;return t.find("li").each(function(){var i=/\btext-([^ ]+)/.exec($(this).find(".subject-name")[0].className),t=/icon-([^ ]+)/.exec($(this).find("[data-icon]")[0].className);a[$(this).data("subject-id")]={icon:t[1],color:i[1],position:n++}}),a}var n=$(".subjects-editor");if(n.length){$("[name=color]").on("change",function(){var a=$(this).parents("li").children("span");a.removeClass(),a.addClass("subject-name text-"+$(this).val())}),$("[name=icon]").on("change",function(){var a=$(this).parents("li").find("[data-icon]");a.removeClass(),a.addClass("icon-"+$(this).val())}),$(".drag").sortable().disableSelection();var i=$("[data-save-url]").data("save-url");$("#save").on("click",function(){window.location=i+"&payload="+JSON.stringify(a())});var t=$(".subject-list")}});

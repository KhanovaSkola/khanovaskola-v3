...
$(function(){$form=$("#frm-registrationForm-form"),$form.length&&$form.find('input[name="password"]').on("change paste keyup",function(){var a=[],n=$form.find('input[name="email"]').val();a.push(n),a.push.apply(a,n.split("@"));var p=$form.find('input[name="name"]').val();a.push(p),a.push.apply(a,p.split(" "));var r=transliterate(p);a.push(r),a.push.apply(a,r.split(" "));var s=zxcvbn($(this).val(),a);$(this).parents(".form-group").toggleClass("has-warning",s.entropy<30)})});

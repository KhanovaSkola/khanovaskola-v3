...
!function(){function e(){t.fadeOut(100),r.fadeOut(500),o.fadeOut(500),u.hide().removeClass("hidden"),App.video.player.playVideo(),setTimeout(function(){i.addClass("video-playmode"),l.fadeIn(700),u.fadeIn(700),t.removeClass("dont-center")},700)}var n=$(".course-video");if(n.length){var o=n.find(".left:first"),i=n.find(".right .right-inner"),t=n.find(".video-play"),r=n.find(".video-preview"),u=n.find(".video-real"),l=n.find(".course-header-footer .left"),d=n.find(".course-progress-container"),c=d.find(".course-progress"),a=d.find(".progress-inner"),s=n.find(".video-click-catcher"),p=n.find(".video-subtitles .subtitles-content"),f=n.find("[data-subtitles-url]").data("subtitles-url"),v=!1;f&&SrtParser.fetch(f,function(e){v=SrtParser.parse(e)});var m=function(e){e||(e=App.video.player.getCurrentTime());var n=e/App.video.duration;a.css("width",100*n+"%"),d.find(".label-left").text(App.filters.duration(e))},g=function(e){var n=e.clientX||e.pageX,o=$(window).width(),i=App.video.duration*n/o;return App.video.player.seekTo(i,!0),App.callAll(App.video.onSeek),m(i),!1},h=function(){1!=App.video.player.getPlayerState()?(E?App.video.player.playVideo():e(),E=!0):App.video.player.pauseVideo()},A=function(){return document.fullscreenElement||document.mozFullScreenElement||document.webkitFullscreenElement||document.msFullscreenElement},y=function(){if(A()){var e=document.exitFullscreen||document.mozCancelFullScreen||document.webkitExitFullscreen||document.msExitFullscreen;e.call(document),n.removeClass("fullscreen")}else{var o=n[0],i=o.requestFullScreen||o.webkitRequestFullScreen||o.mozRequestFullScreen;i.call(o),n.addClass("fullscreen")}return!1};$(document).on("fullscreenchange webkitfullscreenchange mozfullscreenchange msfullscreenchange",function(){A()||n.removeClass("fullscreen")});var k,w=1300;n.on("mousemove",function(){clearTimeout(k),c.addClass("active"),k=setTimeout(function(){c.removeClass("active")},w)});var C=function(){var e=App.video.player.getCurrentTime();if(z){if(v[z][0]<=e&&v[z][1]>=e)return void console.debug("optimization (do not rerender)");if(v[z+1][0]<=e&&v[z+1][1]>=e)return z+=1,console.debug("optimization (rerender)"),void p.text(v[z][2])}console.debug("searching",e),v.every(function(n,o){return n[0]<=e&&n[1]>=e?(console.debug("costly sub search"),p.text(n[2]),z=o,!1):!0})};$("body").on("keydown",function(e){return"input"===e.target.tagName.toLowerCase()?!0:32==e.keyCode?(h(),!1):void 0});var b,T=0,S=200,F=600,x=!1;s.on("click",function(){clearTimeout(b);var e=window.performance?window.performance.now():Date.getTime();return b=setTimeout(function(){h(),x=App.video.player.getCurrentTime()},S),setTimeout(function(){x=!1},F),F>e-T&&(clearTimeout(b),x&&(h(),App.video.player.seekTo(x),x=!1),y()),T=e,!1}),o.on("click",function(){return!1}),App.video.onTick.push(m);var z=!1;App.video.onTick.push(C),App.video.onPlay.push(function(){App.video.player.unloadModule("captions"),App.video.player.unloadModule("cc")}),App.video.onPlay.push(function(){l.find(".toggle .icon").addClass("icon-pause").removeClass("icon-play"),t.fadeOut(180)}),App.video.onPause.push(function(){l.find(".toggle .icon").addClass("icon-play").removeClass("icon-pause"),t.fadeIn(180)}),App.video.onSeek.push(function(){o.is(":visible")&&e()}),App.video.onSeek.push(C);var E=!1;App.video.onInit.push(function(){l.find(".toggle").on("click",function(){return h(),!1}),l.find(".video-fullscreen").on("click",y),d.on("mousedown",function(e){return 1!=e.which?!1:(g(e),$(document).on("mousemove",g),void $(document).on("mouseup",function(){$(document).off("mousemove").off("mouseup")}))})}),App.video.init()}}();

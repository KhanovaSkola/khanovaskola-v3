...
App.elasticSearch={host:"http://localhost:9200"},App.autocomplete=function(t,e){$.ajax({type:"POST",url:App.elasticSearch.host+"/khanovaskola/_suggest",dataType:"json",data:JSON.stringify({content:{text:t,completion:{field:"suggest"}}}),success:function(t){var n=[];$.each(t.content[0].options,function(t,e){n.push({id:e.payload.id,value:e.text})}),e(n)}})},$(function(){$("#frm-search-form-query").typeahead({hint:!0,highlight:!0,minLength:1},{name:"states",source:function(t,e){App.autocomplete(t,function(t){e(t)})}})});

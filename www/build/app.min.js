...
$(function(){var e=$(".dropdown-big");$(".dropdown-big .dropdown-toggle").on("click",function(){return e.toggleClass("open"),e.parents("header").toggleClass("hover"),!1}),$("body").children().not("header").on("click",function(){console.log("closing dropdown"),e.removeClass("open"),e.parents("header").removeClass("hover")}),$(".ul-tab a[data-toggle]").click(function(){return $(this).tab("show"),!1}),$(".search-wrapper .btn-search").on("click",function(){$(this).parents("header").addClass("hover");var e=$(this).parents(".search-wrapper").first(),n=e.find(".search-input"),o=e.find(".search-button"),r=n.hasClass("hidden");return n.removeClass("hidden"),o.removeClass("hidden"),$input=n.find("input:last"),$input.focus(),r?!1:void 0}),$(".search-wrapper .form-control").on("keyup focus",function(){$(this).parents("header").addClass("hover")})});

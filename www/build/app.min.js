...
$(function(){$(".dropdown-big .dropdown-toggle").on("click",function(){var o=$(this).parents(".dropdown").first();o.toggleClass("open")}),$(".ul-tab a").click(function(o){o.preventDefault(),$(this).tab("show")})});

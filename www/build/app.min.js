...
$(function(){var e=$(".landing-page, .subjects-page");if(e.length){console.log(e.find('a[href^="#tab-"]'));var n=$(".dropdown-big");e.find('a[href^="#tab-"]').on("click",function(){return n.toggleClass("open"),n.parents("header").toggleClass("hover"),n.find("a[href="+$(this).attr("href")+"]").tab("show"),window.scrollTo(0,0),!1})}});

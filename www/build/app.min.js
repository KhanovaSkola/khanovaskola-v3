...
$(function(){var n=$(".search-result");if(n.length){App.searchPage=1;var e,a=$("[data-show-more]"),r=function(){return e?!1:(e=$.ajax({url:n.data("url-more"),data:{page:App.searchPage+1},success:function(e){n.append(e),App.searchPage++},complete:function(){e=null}}),!1)};$(window).on("scroll",function(){if(e)return!1;var a=n.children(":nth-last-child(10)");a.length||(a=n.children(":first-child")),a.is(":in-viewport")&&r()}),a.on("click",r)}});

...
!function(){function e(){d.fadeOut(100),l.fadeOut(500),i.fadeOut(500),u.hide().removeClass("hidden"),App.video.player.playVideo(),setTimeout(function(){t.addClass("video-playmode"),r.fadeIn(700),u.fadeIn(700),d.removeClass("dont-center")},700)}var n=$(".course-video");if(n.length){var o,i=(n.find(".course-header-content"),n.find(".left:first")),t=n.find(".right .right-inner"),d=n.find(".video-play"),l=n.find(".video-preview"),u=n.find(".video-real"),r=n.find(".course-header-footer .left"),c=n.find(".course-header-progress"),a=c.find(".progress-inner"),p=n.find(".video-click-catcher"),s=function(e){e||(e=App.video.player.getCurrentTime());var n=e/App.video.duration;a.css("width",100*n+"%"),c.find(".label-left").text(App.filters.duration(e))},f=function(e){var n=e.clientX||e.pageX,o=$(window).width(),i=App.video.duration*n/o;return App.video.player.seekTo(i,!0),App.callAll(App.video.onSeek),s(i),!1},m=function(){1!=App.video.player.getPlayerState()?(w?App.video.player.playVideo():e(),w=!0):App.video.player.pauseVideo()},v=function(){if(document.fullscreenElement||document.mozFullScreenElement||document.webkitFullscreenElement||document.msFullscreenElement){var e=document.exitFullscreen||document.mozCancelFullScreen||document.webkitExitFullscreen||document.msExitFullscreen;e.call(document),n.removeClass("fullscreen")}else{var o=n[0],i=o.requestFullScreen||o.webkitRequestFullScreen||o.mozRequestFullScreen;i.call(o),n.addClass("fullscreen")}return!1},A=0,h=200,g=600,y=!1;p.on("click",function(){clearTimeout(o);var e=window.performance?window.performance.now():Date.getTime();return o=setTimeout(function(){m(),y=App.video.player.getCurrentTime()},h),setTimeout(function(){y=!1},g),g>e-A&&(clearTimeout(o),y&&(m(),App.video.player.seekTo(y),y=!1),v()),A=e,!1}),i.on("click",function(){return!1}),App.video.onTick.push(s),App.video.onPlay.push(function(){r.find(".toggle .icon").addClass("icon-pause").removeClass("icon-play"),d.fadeOut(180)}),App.video.onPause.push(function(){r.find(".toggle .icon").addClass("icon-play").removeClass("icon-pause"),d.fadeIn(180)}),App.video.onSeek.push(function(){i.is(":visible")&&e()});var w=!1;App.video.onInit.push(function(){r.find(".toggle").add(d).on("click",function(){return m(),!1}),r.find(".video-fullscreen").on("click",v),c.on("mousedown",function(e){return 1!=e.which?!1:(f(e),$(document).on("mousemove",f),void $(document).on("mouseup",function(){$(document).off("mousemove").off("mouseup")}))})}),App.video.init()}}();

...
!function(){var e=null,i=0,n=0,o=function(i,n,o){var p=$(".video-wrapper").data("url-event-"+i);return e&&(n.viewId=e),$.ajax(p,{data:n,success:o})};App.video.onInit.push(function(){o("begin",{videoId:$(".video-wrapper").data("video-id")},function(i){e=i.viewId})});var p=0,t=5e3/App.video.tickerDelta,a=function(e){n+=App.video.tickerDelta/1e3,p++,t>p||(p=0,e>i&&(i=e),o("tick",{time:n,percent:n/App.video.duration*100,furthest:i}))};App.video.onTick.push(a);var u,d;App.video.onPause.push(function(e){u=App.getTimer("video:pause"),d=e,p=t,a(e)}),App.video.onPlay.push(function(){u&&o("pause",{at:d,duration:u()/1e3})}),App.video.onSeek.push(function(e,i){o("seek",{from:i,to:e})}),App.video.onChangeView.push(function(e,i){o("change-view",{at:e,isFullscreenNow:i})})}();

...
!function(){function e(){f.show(),u.show(),s.removeClass("video-playmode")}function o(){f.hide(),u.hide(),s.addClass("video-playmode")}function n(){var e=s.find(".video-preview"),o=s.find(".video-real");u.fadeOut(100),e.fadeOut(500),f.fadeOut(500),o.hide().removeClass("hidden"),l.playVideo();setTimeout(function(){s.addClass("video-playmode"),r.fadeIn(700),o.fadeIn(700)},700);return!1}function a(){$(".video-play").on("click",function(){v?l.playVideo():n(),v=!0}),$(".course-header-footer .toggle").on("click",function(){return 1!=l.getPlayerState()?l.playVideo():l.pauseVideo(),!1});var a=$(".course-header-footer .toggle .icon");i.on("video-play",function(){o(),a.removeClass("icon-play").addClass("icon-pause")}),i.on("video-pause",function(){e(),a.removeClass("icon-pause").addClass("icon-play")})}function t(e){if(p!=e.data)switch(p=e.data,e.data){case 1:i.trigger("video-play");break;case 2:i.trigger("video-pause");break;case 0:i.trigger("video-stop")}}var r=$(".course-header-footer .left");if(r.length){var i=$(".video-wrapper");$(".video-fullscreen").click(function(){var e=$(".course-header-content")[0],o=e.requestFullScreen||e.webkitRequestFullScreen||e.mozRequestFullScreen;o.call(e)}),$(document).on("webkitfullscreenchange mozfullscreenchange fullscreenchange",function(){var e=document.fullscreen||document.mozFullScreen||document.webkitIsFullScreen||document.msFullscreenElement||!1;i.toggleClass("fullscreen",e)}),r.hide();var c=document.createElement("script");c.src="https://www.youtube.com/iframe_api";var d=document.getElementsByTagName("script")[0];d.parentNode.insertBefore(c,d);var l;window.onYouTubeIframeAPIReady=function(){l=new YT.Player("youtube-video",{events:{onReady:a,onStateChange:t}})};var u=$(".video-wrapper .video-play"),s=u.parents(".right-inner").first(),f=$(".course-header-content").find(".left"),v=!1,p=-1}}();

...
!function(){function e(){t.fadeOut(100),r.fadeOut(500),o.fadeOut(500),u.hide().removeClass("hidden"),App.video.player.playVideo(),setTimeout(function(){i.addClass("video-playmode"),d.fadeIn(700),u.fadeIn(700),t.removeClass("dont-center")},700)}var n=$(".course-video");if(n.length){var o=n.find(".left:first"),i=n.find(".right .right-inner"),t=n.find(".video-play"),r=n.find(".video-preview"),u=n.find(".video-real"),d=n.find(".course-header-footer .left"),l=n.find(".course-progress-container"),c=l.find(".course-progress"),s=l.find(".progress-inner"),a=n.find(".video-click-catcher"),p=n.find(".video-subtitles .subtitles-content"),f=n.find("[data-subtitles-url]").data("subtitles-url"),v=!1;f&&SrtParser.fetch(f,function(e){v=SrtParser.parse(e)});var m,g=function(e){e||(e=App.video.player.getCurrentTime());var n=e/App.video.duration;s.css("width",100*n+"%"),l.find(".label-left").text(App.filters.duration(e))},y=function(e){var n=e.clientX||e.pageX,o=$(window).width(),i=App.video.duration*n/o;return App.video.player.seekTo(i,!0),App.callAll(App.video.onSeek),g(i),!1},A=function(){1!=App.video.player.getPlayerState()?(x?App.video.player.playVideo():e(),x=!0):App.video.player.pauseVideo()},h=function(){if(document.fullscreenElement||document.mozFullScreenElement||document.webkitFullscreenElement||document.msFullscreenElement){var e=document.exitFullscreen||document.mozCancelFullScreen||document.webkitExitFullscreen||document.msExitFullscreen;e.call(document),n.removeClass("fullscreen")}else{var o=n[0],i=o.requestFullScreen||o.webkitRequestFullScreen||o.mozRequestFullScreen;i.call(o),n.addClass("fullscreen")}return!1},w=function(e){p.text(e)},C=1300;n.on("mousemove",function(){clearTimeout(m),c.addClass("active"),m=setTimeout(function(){c.removeClass("active")},C)}),$("body").on("keydown",function(e){return"input"===e.target.tagName.toLowerCase()?!0:32==e.keyCode?(A(),!1):void 0});var k,b=0,T=200,F=600,S=!1;a.on("click",function(){clearTimeout(k);var e=window.performance?window.performance.now():Date.getTime();return k=setTimeout(function(){A(),S=App.video.player.getCurrentTime()},T),setTimeout(function(){S=!1},F),F>e-b&&(clearTimeout(k),S&&(A(),App.video.player.seekTo(S),S=!1),h()),b=e,!1}),o.on("click",function(){return!1}),App.video.onTick.push(g);var E=!1;App.video.onTick.push(function(){var e=App.video.player.getCurrentTime();if(E){if(v[E][0]<=e&&v[E][1]>=e)return void console.debug("optimization (do not rerender)");if(v[E+1][0]<=e&&v[E+1][1]>=e)return E+=1,console.debug("optimization (rerender)"),void w(v[E][2])}console.debug("searching",e),v.every(function(n,o){return n[0]<=e&&n[1]>=e?(console.debug("costly sub search"),w(n[2]),E=o,!1):!0})}),App.video.onPlay.push(function(){d.find(".toggle .icon").addClass("icon-pause").removeClass("icon-play"),t.fadeOut(180)}),App.video.onPause.push(function(){d.find(".toggle .icon").addClass("icon-play").removeClass("icon-pause"),t.fadeIn(180)}),App.video.onSeek.push(function(){o.is(":visible")&&e()});var x=!1;App.video.onInit.push(function(){d.find(".toggle").on("click",function(){return A(),!1}),d.find(".video-fullscreen").on("click",h),l.on("mousedown",function(e){return 1!=e.which?!1:(y(e),$(document).on("mousemove",y),void $(document).on("mouseup",function(){$(document).off("mousemove").off("mouseup")}))})}),App.video.init()}}();

...
!function(){function e(){u.fadeOut(100),d.fadeOut(500),i.fadeOut(500),r.hide().removeClass("hidden"),App.video.player.playVideo(),setTimeout(function(){t.addClass("video-playmode"),l.fadeIn(700),r.fadeIn(700),u.removeClass("dont-center")},700)}var n=$(".course-video");if(n.length){var o,i=n.find(".left:first"),t=n.find(".right .right-inner"),u=n.find(".video-play"),d=n.find(".video-preview"),r=n.find(".video-real"),l=n.find(".course-header-footer .left"),c=n.find(".course-progress-container"),a=c.find(".course-progress"),s=c.find(".progress-inner"),p=n.find(".video-click-catcher"),f=function(e){e||(e=App.video.player.getCurrentTime());var n=e/App.video.duration;s.css("width",100*n+"%"),c.find(".label-left").text(App.filters.duration(e))},m=function(e){var n=e.clientX||e.pageX,o=$(window).width(),i=App.video.duration*n/o;return App.video.player.seekTo(i,!0),App.callAll(App.video.onSeek),f(i),!1},v=function(){1!=App.video.player.getPlayerState()?(T?App.video.player.playVideo():e(),T=!0):App.video.player.pauseVideo()},A=function(){if(document.fullscreenElement||document.mozFullScreenElement||document.webkitFullscreenElement||document.msFullscreenElement){var e=document.exitFullscreen||document.mozCancelFullScreen||document.webkitExitFullscreen||document.msExitFullscreen;e.call(document),n.removeClass("fullscreen")}else{var o=n[0],i=o.requestFullScreen||o.webkitRequestFullScreen||o.mozRequestFullScreen;i.call(o),n.addClass("fullscreen")}return!1},g=1300;n.on("mousemove",function(){clearTimeout(o),a.addClass("active"),o=setTimeout(function(){a.removeClass("active")},g)}),$("body").on("keydown",function(e){return"input"===e.target.tagName.toLowerCase()?!0:32==e.keyCode?(v(),!1):void 0});var y,w=0,h=200,C=600,k=!1;p.on("click",function(){clearTimeout(y);var e=window.performance?window.performance.now():Date.getTime();return y=setTimeout(function(){v(),k=App.video.player.getCurrentTime()},h),setTimeout(function(){k=!1},C),C>e-w&&(clearTimeout(y),k&&(v(),App.video.player.seekTo(k),k=!1),A()),w=e,!1}),i.on("click",function(){return!1}),App.video.onTick.push(f),App.video.onPlay.push(function(){l.find(".toggle .icon").addClass("icon-pause").removeClass("icon-play"),u.fadeOut(180)}),App.video.onPause.push(function(){l.find(".toggle .icon").addClass("icon-play").removeClass("icon-pause"),u.fadeIn(180)}),App.video.onSeek.push(function(){i.is(":visible")&&e()});var T=!1;App.video.onInit.push(function(){l.find(".toggle").add(u).on("click",function(){return v(),!1}),l.find(".video-fullscreen").on("click",A),c.on("mousedown",function(e){return 1!=e.which?!1:(m(e),$(document).on("mousemove",m),void $(document).on("mouseup",function(){$(document).off("mousemove").off("mouseup")}))})}),App.video.init()}}();

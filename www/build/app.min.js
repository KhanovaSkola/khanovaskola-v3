...
!function(){function e(){t.fadeOut(100),r.fadeOut(500),o.fadeOut(500),u.hide().removeClass("hidden"),App.video.player.playVideo(),setTimeout(function(){i.addClass("video-playmode"),l.fadeIn(700),u.fadeIn(700),t.removeClass("dont-center")},700)}var n=$(".course-video");if(n.length){var o=n.find(".left:first"),i=n.find(".right .right-inner"),t=n.find(".video-play"),r=n.find(".video-preview"),u=n.find(".video-real"),l=n.find(".course-header-footer .left"),c=n.find(".course-progress-container"),d=c.find(".course-progress"),s=c.find(".progress-inner"),a=n.find(".video-click-catcher"),p=n.find(".video-subtitles .subtitles-content"),f=n.find("[data-subtitles-url]").data("subtitles-url"),v=!1;f&&SrtParser.fetch(f,function(e){v=SrtParser.parse(e)});var m=function(e){e||(e=App.video.player.getCurrentTime());var n=e/App.video.duration;s.css("width",100*n+"%"),c.find(".label-left").text(App.filters.duration(e))},g=function(e){var n=e.clientX||e.pageX,o=$(window).width(),i=App.video.duration*n/o;return App.video.player.seekTo(i,!0),App.callAll(App.video.onSeek),m(i),!1},h=function(){1!=App.video.player.getPlayerState()?(x?App.video.player.playVideo():e(),x=!0):App.video.player.pauseVideo()},y=function(){return document.fullscreenElement||document.mozFullScreenElement||document.webkitFullscreenElement||document.msFullscreenElement},A=function(){if(y()){var e=document.exitFullscreen||document.mozCancelFullScreen||document.webkitExitFullscreen||document.msExitFullscreen;e.call(document),n.removeClass("fullscreen")}else{var o=n[0],i=o.requestFullScreen||o.webkitRequestFullScreen||o.mozRequestFullScreen;i.call(o),n.addClass("fullscreen")}return!1};$(document).on("fullscreenchange webkitfullscreenchange mozfullscreenchange msfullscreenchange",function(){y()||n.removeClass("fullscreen")});var w,C=function(e){p.text(e)},k=1300;n.on("mousemove",function(){clearTimeout(w),d.addClass("active"),w=setTimeout(function(){d.removeClass("active")},k)}),$("body").on("keydown",function(e){return"input"===e.target.tagName.toLowerCase()?!0:32==e.keyCode?(h(),!1):void 0});var b,T=0,F=200,S=600,z=!1;a.on("click",function(){clearTimeout(b);var e=window.performance?window.performance.now():Date.getTime();return b=setTimeout(function(){h(),z=App.video.player.getCurrentTime()},F),setTimeout(function(){z=!1},S),S>e-T&&(clearTimeout(b),z&&(h(),App.video.player.seekTo(z),z=!1),A()),T=e,!1}),o.on("click",function(){return!1}),App.video.onTick.push(m);var E=!1;App.video.onTick.push(function(){var e=App.video.player.getCurrentTime();if(E){if(v[E][0]<=e&&v[E][1]>=e)return void console.debug("optimization (do not rerender)");if(v[E+1][0]<=e&&v[E+1][1]>=e)return E+=1,console.debug("optimization (rerender)"),void C(v[E][2])}console.debug("searching",e),v.every(function(n,o){return n[0]<=e&&n[1]>=e?(console.debug("costly sub search"),C(n[2]),E=o,!1):!0})}),App.video.onPlay.push(function(){l.find(".toggle .icon").addClass("icon-pause").removeClass("icon-play"),t.fadeOut(180)}),App.video.onPause.push(function(){l.find(".toggle .icon").addClass("icon-play").removeClass("icon-pause"),t.fadeIn(180)}),App.video.onSeek.push(function(){o.is(":visible")&&e()});var x=!1;App.video.onInit.push(function(){l.find(".toggle").on("click",function(){return h(),!1}),l.find(".video-fullscreen").on("click",A),c.on("mousedown",function(e){return 1!=e.which?!1:(g(e),$(document).on("mousemove",g),void $(document).on("mouseup",function(){$(document).off("mousemove").off("mouseup")}))})}),App.video.init()}}();

...
!function(){var e=null,i=0,n=0,o=!1,p=function(i,n,o){var p=$(".video-wrapper").data("url-event-"+i);return e&&(n.viewId=e),$.ajax(p,{data:n,success:o})};App.video.onInit.push(function(){p("begin",{videoId:$(".video-wrapper").data("video-id")},function(i){e=i.viewId})});var t=0,a=5e3/App.video.tickerDelta,u=function(e){n+=App.video.tickerDelta/1e3,t++,a>t||(t=0,e>i&&(i=e),p("tick",{time:n,percent:n/App.video.duration*100,furthest:i,watched:o?1:0},function(e){o=e.watched}))};App.video.onTick.push(u);var d,v;App.video.onPause.push(function(e){d=App.getTimer("video:pause"),v=e,t=a,u(e)}),App.video.onPlay.push(function(){d&&p("pause",{at:v,duration:d()/1e3})}),App.video.onSeek.push(function(e,i){p("seek",{from:i,to:e})}),App.video.onChangeView.push(function(e,i){p("change-view",{at:e,isFullscreenNow:i})})}();

...
App.debug=window.localStorage?window.localStorage.getItem("debug"):!1,App.debug&&(App.video.onInit.push(function(){console.log("init")}),App.video.onPlay.push(function(){console.log("play")}),App.video.onPause.push(function(){console.log("pause")}),App.video.onTick.push(function(){console.log("tick")}),App.video.onSeek.push(function(){console.log("seek")}),App.video.onStop.push(function(){console.log("stop")}));
...
!function(){function e(){d.fadeOut(100),l.fadeOut(500),i.fadeOut(500),r.hide().removeClass("hidden"),App.video.player.playVideo(),setTimeout(function(){t.addClass("video-playmode"),u.fadeIn(700),r.fadeIn(700),d.removeClass("dont-center")},700)}var n=$(".course-video");if(n.length){var o,i=(n.find(".course-header-content"),n.find(".left:first")),t=n.find(".right .right-inner"),d=n.find(".video-play"),l=n.find(".video-preview"),r=n.find(".video-real"),u=n.find(".course-header-footer .left"),c=n.find(".course-header-progress"),a=c.find(".progress-inner"),p=n.find(".video-click-catcher"),s=function(e){e||(e=App.video.player.getCurrentTime());var n=e/App.video.duration;a.css("width",100*n+"%"),c.find(".label-left").text(App.filters.duration(e))},f=function(e){var n=e.clientX||e.pageX,o=$(window).width(),i=App.video.duration*n/o;return App.video.player.seekTo(i,!0),App.callAll(App.video.onSeek),s(i),!1},m=function(){1!=App.video.player.getPlayerState()?(w?App.video.player.playVideo():e(),w=!0):App.video.player.pauseVideo()},v=function(){if(document.fullscreenElement||document.mozFullScreenElement||document.webkitFullscreenElement||document.msFullscreenElement){var e=document.exitFullscreen||document.mozCancelFullScreen||document.webkitExitFullscreen||document.msExitFullscreen;e.call(document),n.removeClass("fullscreen")}else{var o=n[0],i=o.requestFullScreen||o.webkitRequestFullScreen||o.mozRequestFullScreen;i.call(o),n.addClass("fullscreen")}return!1},A=0,g=200,y=600,h=!1;p.on("click",function(){clearTimeout(o);var e=window.performance?window.performance.now():Date.getTime();return o=setTimeout(function(){m(),h=App.video.player.getCurrentTime()},g),setTimeout(function(){h=!1},y),y>e-A&&(clearTimeout(o),h&&(m(),App.video.player.seekTo(h),h=!1),v()),A=e,!1}),i.on("click",function(){return!1}),App.video.onTick.push(s),App.video.onPlay.push(function(){u.find(".toggle .icon").addClass("icon-pause").removeClass("icon-play"),d.fadeOut(180)}),App.video.onPause.push(function(){u.find(".toggle .icon").addClass("icon-play").removeClass("icon-pause"),d.fadeIn(180)});var w=!1;App.video.onInit.push(function(){u.find(".toggle").add(d).on("click",function(){return m(),!1}),u.find(".video-fullscreen").on("click",v),c.on("mousedown",function(e){f(e),$(document).on("mousemove",f)}),$(document).on("mouseup",function(){$(document).off("mousemove")})}),App.video.init()}}();

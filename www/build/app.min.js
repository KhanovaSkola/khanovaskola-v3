...
App.video={},App.video.tickerDelta=100,App.video.onInit=[],App.video.onPlay=[],App.video.onPause=[],App.video.onTick=[],App.video.onSeek=[],App.video.onStop=[],App.video.init=function(){window.onYouTubeIframeAPIReady=function(){App.video.player=new YT.Player("youtube-video",{events:{onReady:App.video.onPlayerReady,onStateChange:App.video.onPlayerStateChange}})};var e=document.createElement("script");e.src="https://www.youtube.com/iframe_api";var p=document.getElementsByTagName("script")[0];p.parentNode.insertBefore(e,p)},App.video.onPlayerReady=function(){App.callAll(App.video.onInit),App.video.duration=App.video.player.getDuration()},App.video.onPlayerStateChange=function(e){clearInterval(App.video.ticker);var p=e.data;switch(p){case 1:App.video.ticker=setInterval(function(){App.callAll(App.video.onTick)},App.video.tickerDelta),App.callAll(App.video.onPlay);break;case 2:App.callAll(App.video.onPause);break;case 0:App.callAll(App.video.onStop)}};
...
!function(){function e(){t.fadeOut(100),r.fadeOut(500),o.fadeOut(500),u.hide().removeClass("hidden-video"),App.video.player.playVideo(),setTimeout(function(){i.addClass("video-playmode"),l.fadeIn(700),u.fadeIn(700),t.removeClass("dont-center")},700)}var n=$(".course-video");if(n.length){var o=n.find(".left:first"),i=n.find(".right .right-inner"),t=n.find(".video-play"),r=n.find(".video-preview"),u=n.find(".video-real"),l=n.find(".course-header-footer .left"),d=n.find(".video-controls"),c=n.find(".course-progress-container"),s=c.find(".course-progress"),a=c.find(".progress-inner"),p=n.find(".video-click-catcher"),f=n.find(".video-subtitles .subtitles-content"),v=n.find("[data-subtitles-url]").data("subtitles-url"),m=!1;v&&SrtParser.fetch(v,function(e){m=SrtParser.parse(e)});var g=function(e){e||(e=App.video.player.getCurrentTime());var n=e/App.video.duration;a.css("width",100*n+"%"),c.find(".label-left").text(App.filters.duration(e))},h=function(e){var n=e.clientX||e.pageX,o=$(window).width(),i=App.video.duration*n/o;return App.video.player.seekTo(i,!0),App.callAll(App.video.onSeek),g(i),!1},A=function(){1!=App.video.player.getPlayerState()?(E?App.video.player.playVideo():e(),E=!0):App.video.player.pauseVideo()},y=function(){return document.fullscreenElement||document.mozFullScreenElement||document.webkitFullscreenElement||document.msFullscreenElement},C=function(){if(y()){var e=document.exitFullscreen||document.mozCancelFullScreen||document.webkitExitFullscreen||document.msExitFullscreen;e.call(document),n.removeClass("fullscreen")}else{var o=n[0],i=o.requestFullScreen||o.webkitRequestFullScreen||o.mozRequestFullScreen||o.msRequestFullscreen;i.call(o),n.addClass("fullscreen")}return!1};$(document).on("fullscreenchange webkitfullscreenchange mozfullscreenchange msfullscreenchange",function(){y()?s.addClass("active-fs"):(n.removeClass("fullscreen"),s.removeClass("active-fs"))});var k;n.on("mousemove",function(){clearTimeout(k);var e=y();e?d.addClass("active"):s.addClass("active"),k=setTimeout(function(){s.removeClass("active"),d.removeClass("active")},e?3e3:1800)});var w=function(){var e=App.video.player.getCurrentTime();if(z){if(m[z][0]<=e&&m[z][1]>=e)return void console.debug("optimization (do not rerender)");if(m[z+1][0]<=e&&m[z+1][1]>=e)return z+=1,console.debug("optimization (rerender)"),void f.text(m[z][2])}console.debug("searching",e),m.every(function(n,o){return n[0]<=e&&n[1]>=e?(console.debug("costly sub search"),f.text(n[2]),z=o,!1):!0})};$("body").on("keydown",function(e){return"input"===e.target.tagName.toLowerCase()?!0:32==e.keyCode?(A(),!1):void 0});var b,T=0,F=200,S=600,x=!1;p.on("click",function(){clearTimeout(b);var e=window.performance?window.performance.now():Date.getTime();return b=setTimeout(function(){A(),x=App.video.player.getCurrentTime()},F),setTimeout(function(){x=!1},S),S>e-T&&(clearTimeout(b),x&&(A(),App.video.player.seekTo(x),x=!1),C()),T=e,!1}),o.on("click",function(){return!1}),App.video.onTick.push(g);var z=!1;App.video.onTick.push(w),App.video.onPlay.push(function(){App.video.player.unloadModule("captions"),App.video.player.unloadModule("cc")}),App.video.onPlay.push(function(){l.find(".toggle .icon").addClass("icon-pause").removeClass("icon-play"),t.fadeOut(180)}),App.video.onPause.push(function(){l.find(".toggle .icon").addClass("icon-play").removeClass("icon-pause"),t.fadeIn(180)}),App.video.onSeek.push(function(){o.is(":visible")&&e()}),App.video.onSeek.push(w);var E=!1;App.video.onInit.push(function(){l.find(".toggle").on("click",function(){return A(),!1}),l.find(".video-fullscreen").on("click",C),c.on("mousedown",function(e){return 1!=e.which?!1:(h(e),$(document).on("mousemove",h),void $(document).on("mouseup",function(){$(document).off("mousemove").off("mouseup")}))})}),App.video.init()}}();

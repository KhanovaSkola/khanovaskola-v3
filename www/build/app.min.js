...
$(function(){var o=$(".dropdown-big");$(".dropdown-big .dropdown-toggle").on("click",function(){console.log("open"),o.toggleClass("open"),o.parents("header").toggleClass("hover")}),$("body").children().not("header").on("click",function(){console.log("close"),o.removeClass("open"),o.parents("header").removeClass("hover")}),$(".ul-tab a").click(function(o){o.preventDefault(),$(this).tab("show")})});

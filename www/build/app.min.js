...
App.elasticSearch=new $.es.Client({hosts:"http://localhost:9200"}),App.autocomplete=function(t,e){App.elasticSearch.suggest({index:"khanovaskola",body:{content:{text:t,completion:{field:"suggest"}}}}).then(function(t){var n=[];$.each(t.content[0].options,function(t,e){n.push({id:e.payload.id,value:e.text})}),e(n)})},$(function(){$("#frm-search-form-query").typeahead({hint:!0,highlight:!0,minLength:1},{name:"states",source:function(t,e){App.autocomplete(t,function(t){e(t)})}})});

...
!function(n){function e(e){var t,o=n("<div></div>").css({width:"100%"});return e.append(o),t=e.width()-o.width(),o.remove(),t}function t(o,r){var i=o.getBoundingClientRect(),a=i.top,s=i.bottom,c=i.left,l=i.right,u=n.extend({tolerance:0,viewport:window},r),d=!1,f=u.viewport.get?u.viewport:n(u.viewport);f.length||(console.warn("isInViewport: The viewport selector you have provided matches no element on page."),console.warn("isInViewport: Defaulting to viewport as window"),f=n(window));var w=f.height(),p=f.width(),h=f.get(0).toString();if("[object Window]"!==h&&"[object DOMWindow]"!==h){var v=f.offset();a-=v.top,s-=v.top,c-=v.left,l=c+p,t.scrollBarWidth=t.scrollBarWidth||e(f),p-=t.scrollBarWidth}return u.tolerance=~~Math.round(parseFloat(u.tolerance)),u.tolerance<0&&(u.tolerance=w+u.tolerance),Math.abs(c)>=p?d:d=u.tolerance?!!(a<=u.tolerance&&s>=u.tolerance):!!(s>0&&w>=a)}var o=function(e){if(1===arguments.length&&"function"==typeof e&&(e=[e]),!(e instanceof Array))throw new SyntaxError("isInViewport: Argument(s) passed to .do/.run should be a function or an array of functions");for(var t=0;t<e.length;t++)if("function"==typeof e[t])for(var o=0;o<this.length;o++)e[t].call(n(this[o]));else console.warn("isInViewport: Argument(s) passed to .do/.run should be a function or an array of functions"),console.warn("isInViewport: Ignoring non-function values in array and moving on");return this};try{n.fn.do=function(n){return console.warn("isInViewport: .do causes issues in IE and some browsers since its a reserved. Use $.fn.run instead i.e., $(el).run(fn)."),o(n)},n.fn.run=o}catch(r){n.fn.run=o}n.extend(n.expr[":"],{"in-viewport":function(n,e,o){if(o[3]){var r=o[3].split(",");return 1===r.length&&isNaN(r[0])&&(r[1]=r[0],r[0]=void 0),t(n,{tolerance:r[0]?r[0].trim():void 0,viewport:r[1]?r[1].trim():void 0})}return t(n)}})}(jQuery);
var App={};App.error=function(r){console.error("Error:",r)},App.getTime=function(){var r=new Date;return r.getTime()},App.getTimer=function(){var r=App.getTime();return function(){return App.getTime()-r}},App.callAll=function(r,e){r.forEach(function(r){r.apply(null,e)})};
App.filters={duration:function(r){var o=Math.floor(r/60),t=Math.floor(r-60*o);return o+":"+(10>t?"0"+t:t)}};
!function(){App.remote={},App.remote.guessGender=function(e,s){$.ajax({url:"/js/guess-gender",data:{name:e},success:s})}}();
App.video={},App.video.tickerDelta=100,App.video.onInit=[],App.video.onPlay=[],App.video.onPause=[],App.video.onTick=[],App.video.onSeek=[],App.video.onStop=[],App.video.onChangeView=[],App.video.init=function(){window.onYouTubeIframeAPIReady=function(){App.video.player=new YT.Player("youtube-video",{events:{onReady:App.video.onPlayerReady,onStateChange:App.video.onPlayerStateChange}})};var e=document.createElement("script");e.src="https://www.youtube.com/iframe_api";var p=document.getElementsByTagName("script")[0];p.parentNode.insertBefore(e,p)},App.video.onPlayerReady=function(){App.callAll(App.video.onInit),App.video.duration=App.video.player.getDuration()},App.video.onPlayerStateChange=function(e){clearInterval(App.video.ticker);var p=e.data;switch(p){case 1:App.video.ticker=setInterval(function(){App.callAll(App.video.onTick,[App.video.player.getCurrentTime()])},App.video.tickerDelta),App.callAll(App.video.onPlay);break;case 2:App.callAll(App.video.onPause,[App.video.player.getCurrentTime()]);break;case 0:App.callAll(App.video.onStop,[App.video.player.getCurrentTime()])}};
!function(){var e=null,i=0,n=0,o=!1,a=function(i,n,o){var a=$(".video-wrapper").data("url-event-"+i);return e&&(n.viewId=e),$.ajax(a,{data:n,success:o})};App.video.onInit.push(function(){var i=$(".video-wrapper");a("begin",{videoId:i.data("video-id"),blockId:i.data("block-id"),schemaId:i.data("schema-id")},function(i){e=i.viewId})});var t=0,p=5e3/App.video.tickerDelta,d=function(e){n+=App.video.tickerDelta/1e3,t++,p>t||(t=0,e>i&&(i=e),a("tick",{time:n,percent:n/App.video.duration*100,furthest:i,watched:o?1:0},function(e){o=e.watched}))};App.video.onTick.push(d);var u,c;App.video.onPause.push(function(e){u=App.getTimer("video:pause"),c=e,t=p,d(e)}),App.video.onPlay.push(function(){u&&a("pause",{at:c,duration:u()/1e3})}),App.video.onSeek.push(function(e,i){a("seek",{from:i,to:e})}),App.video.onChangeView.push(function(e,i){a("change-view",{at:e,isFullscreenNow:i})})}();
...
$(function(){$(".floating-placeholder input").keyup(function(){$(this).parents(".floating-placeholder").first().toggleClass("float",!!$(this).val())})});
$(function(){var e=$(".dropdown");$(".dropdown .dropdown-toggle").on("click",function(){return $(this).parents(".dropdown").toggleClass("open"),e.parents("header").toggleClass("hover"),!1}),$("body").children().not("header").on("click",function(){e.removeClass("open"),e.parents("header").removeClass("hover")}),$(".ul-tab a[data-toggle]").click(function(){return $(this).tab("show"),!1}),$(".search-wrapper .btn-search").on("click",function(){$(this).parents("header").addClass("hover");var e=$(this).parents(".search-wrapper").first(),r=e.find(".search-input"),n=e.find(".search-button"),o=r.hasClass("hidden");return r.removeClass("hidden"),n.removeClass("hidden"),$input=r.find("input:last"),$input.focus(),o?!1:void 0}),$(".search-wrapper .form-control").on("keyup focus",function(){$(this).parents("header").addClass("hover")})});
...
$(function(){var e=$(".search-result");if(e.length){App.searchPage=1;var n,r=$("[data-show-more]"),a=function(){return n?!1:(n=$.ajax({url:e.data("url-more"),data:{page:App.searchPage+1},success:function(n){n.trim()||r.hide(),e.append(n),App.searchPage++},complete:function(){n=null}}),!1)};$(window).on("scroll",function(){if(n)return!1;var r=e.children(":nth-last-child(10)");r.length||(r=e.children(":first-child")),r.is(":in-viewport")&&a()}),r.on("click",a)}});
$(function(){$(".toggle-password").click(function(){var t=$(this).parents("form").find("[name=password]");t.attr("type","password"===t.attr("type")?"text":"password")})});
$(function(){var n=$(".landing-page, .subjects-page");if(n.length){var e=$(".dropdown-big");return n.find('main a[href^="#tab-"]').on("click",function(){return e.toggleClass("open"),e.parents("header").toggleClass("hover"),e.find("a[href="+$(this).attr("href")+"]").tab("show"),window.scrollTo(0,0),!1}),!1}});
...
!function(){smoothScroll.init({speed:300,easing:"easeInOutCubic",updateURL:!0,offset:0})}();
!function(){function e(){t.fadeOut(100),r.fadeOut(500),o.fadeOut(500),l.hide().removeClass("hidden-video"),App.video.player.playVideo(),setTimeout(function(){i.addClass("video-playmode"),u.fadeIn(700),l.fadeIn(700),t.removeClass("dont-center")},700)}var n=$(".course-video");if(n.length){var o=n.find(".left:first"),i=n.find(".right .right-inner"),t=n.find(".video-play"),r=n.find(".video-preview"),l=n.find(".video-real"),u=n.find(".course-header-footer .left"),d=n.find(".video-controls"),c=n.find(".course-progress-container"),a=c.find(".course-progress"),s=c.find(".progress-inner"),p=n.find(".video-click-catcher"),f=n.find(".video-subtitles .subtitles-content"),v=n.find("[data-subtitles-url]").data("subtitles-url"),m=!1;v&&SrtParser.fetch(v,function(e){m=SrtParser.parse(e)});var A=function(e){e||(e=App.video.player.getCurrentTime());var n=e/App.video.duration;s.css("width",100*n+"%"),c.find(".label-left").text(App.filters.duration(e))},g=function(e){var n=e.clientX||e.pageX,o=$(window).width(),i=App.video.duration*n/o,t=App.video.player.getCurrentTime();return App.video.player.seekTo(i,!0),App.callAll(App.video.onSeek,[i,t]),A(i),!1},h=function(){1!=App.video.player.getPlayerState()?(E?App.video.player.playVideo():e(),E=!0):App.video.player.pauseVideo()},y=function(){return document.fullscreenElement||document.mozFullScreenElement||document.webkitFullscreenElement||document.msFullscreenElement},C=function(){if(y()){var e=document.exitFullscreen||document.mozCancelFullScreen||document.webkitExitFullscreen||document.msExitFullscreen;e.call(document),n.removeClass("fullscreen"),App.callAll(App.video.onChangeView,[App.video.player.getCurrentTime(),!1])}else{var o=n[0],i=o.requestFullScreen||o.webkitRequestFullScreen||o.mozRequestFullScreen||o.msRequestFullscreen;i.call(o),n.addClass("fullscreen"),App.callAll(App.video.onChangeView,[App.video.player.getCurrentTime(),!0])}return!1};$(document).on("fullscreenchange webkitfullscreenchange mozfullscreenchange msfullscreenchange",function(){y()?a.addClass("active-fs"):(n.removeClass("fullscreen"),a.removeClass("active-fs"))});var w;n.on("mousemove",function(){clearTimeout(w);var e=y();e?d.addClass("active"):a.addClass("active"),w=setTimeout(function(){a.removeClass("active"),d.removeClass("active")},e?3e3:1800)});var k=function(e){if(z){if(m[z][0]<=e&&m[z][1]>=e)return void console.debug("optimization (do not rerender)");if(m[z+1][0]<=e&&m[z+1][1]>=e)return z+=1,console.debug("optimization (rerender)"),void f.text(m[z][2])}console.debug("searching",e),m.every(function(n,o){return n[0]<=e&&n[1]>=e?(console.debug("costly sub search"),f.text(n[2]),z=o,!1):!0})};$("body").on("keydown",function(e){return"input"===e.target.tagName.toLowerCase()?!0:32==e.keyCode?(h(),!1):void 0});var T,b=0,F=200,S=600,x=!1;p.on("click",function(){clearTimeout(T);var e=window.performance?window.performance.now():Date.getTime();return T=setTimeout(function(){h(),x=App.video.player.getCurrentTime()},F),setTimeout(function(){x=!1},S),S>e-b&&(clearTimeout(T),x&&(h(),App.video.player.seekTo(x),x=!1),C()),b=e,!1}),o.on("click",function(){return!1}),App.video.onTick.push(A);var z=!1;App.video.onTick.push(k),App.video.onPlay.push(function(){App.video.player.unloadModule("captions"),App.video.player.unloadModule("cc")}),App.video.onPlay.push(function(){u.find(".toggle .icon").addClass("icon-pause").removeClass("icon-play"),t.fadeOut(180)}),App.video.onPause.push(function(){u.find(".toggle .icon").addClass("icon-play").removeClass("icon-pause"),t.fadeIn(180)}),App.video.onSeek.push(function(){o.is(":visible")&&e()}),App.video.onSeek.push(k);var E=!1;App.video.onInit.push(function(){u.find(".toggle").on("click",function(){return h(),!1}),u.find(".video-fullscreen").on("click",C),c.on("mousedown",function(e){return 1!=e.which?!1:(g(e),$(document).on("mousemove",g),void $(document).on("mouseup",function(){$(document).off("mousemove").off("mouseup")}))})}),App.video.init()}}();
App.elasticSearch={host:"http://localhost:9200"},App.autocomplete=function(t,e){$.ajax({type:"POST",url:App.elasticSearch.host+"/khanovaskola/_suggest",dataType:"json",data:JSON.stringify({content:{text:t,completion:{field:"suggest"}}}),success:function(t){var n=[];$.each(t.content[0].options,function(t,e){n.push({id:e.payload.id,value:e.text})}),e(n)}})},$(function(){$("#frm-search-form-query").typeahead({hint:!0,highlight:!1,minLength:1},{name:"states",source:function(t,e){App.autocomplete(t,function(t){e(t)})}}).on("typeahead:selected",function(t,e){var n=$(this).parents("form").data("url-direct")+"?contentId="+e.id;window.location.href=n})});
!function(){var n=$("#frm-blueprintEditor-form");if(n.length){var a={};a.saveHook=function(n,a,e){var r=function(){for(var r in e)n[r]=e[r].val();a.val(JSON.stringify(n))};for(var t in e)e[t].on("change",r);r()},a.label=function(n){switch(n){case"integer":return"celé číslo";case"list":return"náhodné slovo";case"plural":return"plurál"}},a.render=function(n,e){var r=$("<div></div>").text(this.label(n.type));e.hide(),e.before(r);var t="render"+n.type.charAt(0).toUpperCase()+n.type.slice(1);a[t](n,r,e)},a.renderInteger=function(n,e,r){var t=$('<input type="number" class="form-control">').val(n.min),i=$('<input type="number" class="form-control">').val(n.max);e.append(t).append(i),a.saveHook(n,r,{min:t,max:i})},a.renderPlural=function(n,e,r){var t={},i=["count","one","few","many"];for(var o in i){var l=i[o];t[l]=$('<input class="form-control">').val(n[l]),e.append(t[l])}a.saveHook(n,r,t)},a.renderList=function(n,a,e){var r={};for(var t in n.list){r[t]=$('<input class="form-control">').val(n.list[t]),a.append(r[t]);var i=function(){n.list=[];for(var a in r)n.list.push(r[a].val());e.val(JSON.stringify(n))};r[t].on("change",i),i()}e.val(JSON.stringify(n))},n.find("[data-definition]").each(function(n,e){var r=JSON.parse($(e).val());a.render(r,$(e))});var e=n.find("[data-definitions]");n.find("[data-add-type]").on("click",function(){var n=$(this).data("add-type"),r=e.find("[data-definition]").length,t=$('<input name="vars['+r+'][name]" class="form-control">'),i=$('<input name="vars['+r+'][definition]" data-definition class="form-control">');e.append(t).append(i);var o={type:n};"integer"===n?(o.min=0,o.max=100):"list"===n?o.list=[]:"plural"===n&&(o={type:n,count:"<eval></eval>",one:"",few:"",many:""}),a.render(o,i)});var r,t,i;e.find("[data-var-remove]").click(function(n){i&&i.remove();var a=$(n.target),o=e.find('[data-var-id="'+a.data("var-remove")+'"]');t=$("<div></div>"),o.after(t),i=$('<a class="btn btn-link"></a>').text(a.data("label-undo")).on("click",function(){t.after(r),t.remove(),i.remove()}),o.after(i),o.detach(),r=o})}}();
$(function(){var n=$("#frm-linkStudentsForm-form");if(n.length){var t=n.find("input[type=email]").last().clone();n.countEmpty=function(){var n=0;return $(this).find("input[type=email]").each(function(t,e){$(e).val().trim()||n++}),n},n.on("change keyup paste","input[type=email]",function(){if(console.log(n.countEmpty()),n.countEmpty()<1){var e=t.clone(),i=n.find("input[type=email]").length;e.attr("name","emails["+i+"][email]"),n.find(".form-group").append(e)}})}});
...
$(function(){if($form=$("#frm-registrationForm-form"),$form.length){var n=null;$form.find('input[name="name"]').on("change paste keyup",function(){n&&clearTimeout(n),App.remote.guessGender($(this).val(),function(e){n=setTimeout(function(){$("#frm-registrationForm-form-gender-"+e.gender).prop("checked",!0)},200)})}),$form.find('input[name="password"]').on("change paste keyup",function(){var n=[],e=$form.find('input[name="email"]').val();n.push(e),n.push.apply(n,e.split("@"));var r=$form.find('input[name="name"]').val();n.push(r),n.push.apply(n,r.split(" "));var a=transliterate(r);n.push(a),n.push.apply(n,a.split(" "));var t=zxcvbn($(this).val(),n);$(this).parents(".form-group").toggleClass("has-warning",t.entropy<30)})}});
